        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <span className="text-2xl font-bold bg-gradient-to-r from-[#0078d4] to-[#00bcf2] bg-clip-text text-transparent">
                MasterMinds
              </span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-700 hover:text-[#0078d4] transition-colors">Home</a>
              <a href="#" className="text-gray-700 hover:text-[#0078d4] transition-colors">Courses</a>
              <a href="#" className="text-gray-700 hover:text-[#0078d4] transition-colors">Success Stories</a>
              <a href="#" className="text-gray-700 hover:text-[#0078d4] transition-colors">Contact</a>
            </div>
            
            {/* CTA Button */}
            <button className="bg-gradient-to-r from-[#0078d4] to-[#00bcf2] text-white px-6 py-2 rounded-full text-sm font-semibold hover:shadow-lg transition-all">
              Enroll Now
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
          <div className="space-y-6 md:space-y-8 text-center lg:text-left reveal stagger-child">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2 md:pt-4 justify-center lg:justify-start stagger-child">
              <button className="w-full sm:w-auto px-6 py-4 bg-[#0078d4] text-white rounded-xl font-semibold shadow-lg shadow-blue-500/30 hover:bg-[#0063b1] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 group">
                Explore Courses <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="w-full sm:w-auto px-6 py-4 bg-white/90 text-slate-700 border border-slate-200 rounded-xl font-semibold hover:bg-white transition-all flex items-center justify-center gap-2 backdrop-blur-md shadow-sm hover:shadow-md">
        ...
        <div className="max-w-6xl mx-auto bg-white/80 backdrop-blur-xl rounded-[2rem] md:rounded-[3rem] shadow-2xl border border-white/60 overflow-hidden hover:shadow-3xl transition-shadow duration-500">
          <div className="flex flex-col lg:flex-row min-h-auto lg:min-h-[500px]">
            ...
            <div className="w-full lg:w-3/5 p-8 sm:p-10 md:p-16 flex flex-col justify-center text-center lg:text-left relative">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900 mb-2">Krithika</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {visibleCourses.map((course, i) => (
              <div key={`${currentCourseIndex}-${i}`} className={`group bg-white/90 backdrop-blur-xl rounded-[1.5rem] md:rounded-3xl p-6 md:p-8 border border-white shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 animate-slide-in-right ${course.border} border-2 border-transparent hover:border-current`}>
                ...
                <span className={`${course.btn} font-bold text-sm md:text-base inline-flex items-center gap-2 group-hover:gap-3 transition-all cursor-pointer`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto lg:h-[600px]">
            ...
            <div className="flex flex-col gap-6 h-full">
              <div className="flex-1 bg-slate-200 rounded-[2rem] md:rounded-[2.5rem] overflow-hidden shadow-lg border border-white relative min-h-[250px] md:min-h-[300px] group">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3168.628236556408!2d-122.08625158432676!3d37.4220040798247!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808fb7495e34771b%3A0x2343d87f79a9220e!2sGoogleplex!5e0!3m2!1sen!2sin!4v1684490000000!5m2!1sen!2sin" width="100%" height="100%" style={{border:0, filter: 'grayscale(100%) contrast(1.2)'}} className="absolute inset-0 group-hover:filter group-hover:grayscale-50 transition-all duration-700"></iframe>
